...
export default function CardProducts({ title, price, img, onClick } : CardProductsProps) {
    return (
        <article onClick={onClick} className="bg-base-200/50 backdrop-blur-sm backdrop-opacity-30 rounded-lg p-4 shadow-xl cursor-pointer hover:scale-105 transition-all duration-300">
